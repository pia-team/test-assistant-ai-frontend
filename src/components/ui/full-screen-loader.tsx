        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-6">
            ...
            <div className="relative w-24 h-24">
              ...
              <div
                className="absolute inset-0 rounded-full border-4 border-transparent bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500 animate-spin-slow opacity-80"
                style={{
              ...
              <div
                className="absolute inset-3 rounded-full border-4 border-transparent bg-gradient-to-r from-pink-500 via-orange-400 to-pink-500 animate-spin-reverse opacity-70"
                style={{
                  mask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                  maskComposite: "exclude",
                  padding: "4px",
