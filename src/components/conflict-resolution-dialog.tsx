    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl max-h-[85vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            {dictionary.conflict.description.replace(
              "{count}",
        ...
        <ScrollArea className="max-h-[400px] pr-4">
          <div className="space-y-3">
            {conflicts.map((conflict) => {
              ...
              const fileName =
                conflict.fileName.split("/").pop() || conflict.fileName;
              ...
              return (
                ...
                >
                  <div
                    onClick={() =>
                      setExpandedFile(isExpanded ? null : conflict.fileName)
                    }
